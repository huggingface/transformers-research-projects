...
class ModelArguments:
    ...
    squat_lambda: Optional[float] = field(
        default=0.001,
        metadata={"help": "Squat lambda"},
    )
    subspace_dim: Optional[int] = field(
        default=20,
        metadata={"help": "Subspace dimension"},
    )
    quant_group_size: Optional[int] = field(
        default=64,
        metadata={"help": "Quantization group size"},
    )
    shared_svd: Optional[bool] = field(
        default=True,
        metadata={"help": "Shared SVD"},
    )
    model_maxlen: Optional[int] = field(
        default=0,
